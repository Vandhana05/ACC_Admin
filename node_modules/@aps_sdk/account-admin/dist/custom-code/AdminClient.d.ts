...
export declare class AdminClient {
     ...
     */
    getProject(accessToken: string, projectId: string, optionalArgs?: {
        region?: Region;
        fields?: Array<Fields>;
     ...
     * @memberof ProjectsApi
     */
    getProjects(accessToken: string, accountId: string, optionalArgs?: {
        region?: Region;
        fields?: Array<Fields>;
        filterClassification?: Array<Classification>;
        filterPlatform?: Array<Platform>;
        filterProducts?: Array<Products>;
        filterName?: string;
        filterType?: Array<string>;
        filterStatus?: Array<Status>;
        filterBusinessUnitId?: string;
     ...
     * @memberof ProjectsApi
     */
    createProject(accessToken: string, accountId: string, projectPayload: ProjectPayload, optionalArgs?: {
        region?: Region;
        adminUserId?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<Project>;
     ...
     * @memberof ProjectsApi
     */
    createProjectImage(accessToken: string, projectId: string, accountId: string, body: File, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
     ...
     */
    searchCompanies(accessToken: string, accountId: string, optionalArgs?: {
        region?: Region;
        name?: string;
        trade?: string;
        operator?: string;
     ...
     * @memberof CompaniesApi
     */
    patchCompanyImage(accessToken: string, companyId: string, accountId: string, body: File, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<Company>;
    /**
     ...
     * @memberof CompaniesApi
     */
    patchCompanyDetails(accessToken: string, companyId: string, accountId: string, companyPatchPayload: CompanyPatchPayload, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<Company>;
    /**
     ...
     * @memberof CompaniesApi
     */
    importCompanies(accessToken: string, accountId: string, companyPayload: Array<CompanyPayload>, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof CompaniesApi
     */
    getProjectCompanies(accessToken: string, accountId: string, projectId: string, optionalArgs?: {
        region?: Region;
        limit?: number;
        offset?: number;
        sort?: string;
     ...
     * @memberof CompaniesApi
     */
    getCompany(accessToken: string, companyId: string, accountId: string, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<Company>;
    /**
     ...
     * @memberof CompaniesApi
     */
    getCompanies(accessToken: string, accountId: string, optionalArgs?: {
        region?: Region;
        limit?: number;
        offset?: number;
        sort?: string;
     ...
     * @memberof CompaniesApi
     */
    createCompany(accessToken: string, accountId: string, companyPayload: CompanyPayload, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<Company>;
    /**
     ...
     */
    getProjectUser(accessToken: string, projectId: string, userId: string, optionalArgs?: {
        region?: Region;
        fields?: any;
        options?: ApsServiceRequestConfig;
    }): Promise<ProjectUser>;
     ...
     * @memberof ProjectUsersApi
     */
    assignProjectUser(accessToken: string, projectId: string, projectUserPayload: ProjectUserPayload, optionalArgs?: {
        region?: Region;
        adminUserId?: string;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof ProjectUsersApi
     */
    getProjectUsers(accessToken: string, projectId: string, optionalArgs?: {
        region?: Region;
        filterProducts?: Array<Products>;
        filterName?: string;
        filterEmail?: string;
        filterStatus?: Array<StatusFilter>;
        filterAccessLevels?: Array<AccessLevels>;
        filterCompanyId?: string;
        filterCompanyName?: string;
        filterAutodeskId?: Array<string>;
        filterId?: Array<string>;
        filterRoleId?: string;
        filterRoleIds?: Array<string>;
        sort?: Array<UserSortBy>;
        fields?: Array<UserFields>;
        orFilters?: Array<OrFilters>;
        filterTextMatch?: FilterTextMatch;
        limit?: number;
        offset?: number;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof ProjectUsersApi
     */
    importProjectUsers(accessToken: string, projectId: string, projectUsersImportPayload: ProjectUsersImportPayload, optionalArgs?: {
        region?: Region;
        adminUserId?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ProjectUsersImportResponse>;
    /**
     ...
     * @memberof ProjectUsersApi
     */
    removeProjectUser(accessToken: string, projectId: string, userId: string, optionalArgs?: {
        region?: Region;
        adminUserId?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<void>;
     ...
     * @memberof ProjectUsersApi
     */
    updateProjectUser(accessToken: string, projectId: string, userId: string, projectUsersUpdatePayload: ProjectUsersUpdatePayload, optionalArgs?: {
        region?: Region;
        adminUserId?: string;
        options?: ApsServiceRequestConfig;
    }): Promise<ProjectUserResponse>;
     ...
     */
    createUser(accessToken: string, accountId: string, userPayload: UserPayload, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<User>;
    /**
     ...
     * @memberof AccountUsersApi
     */
    getUser(accessToken: string, accountId: string, userId: string, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<User>;
    /**
     ...
     * @memberof AccountUsersApi
     */
    getUsers(accessToken: string, accountId: string, optionalArgs?: {
        region?: Region;
        limit?: number;
        offset?: number;
        sort?: string;
     ...
     * @memberof AccountUsersApi
     */
    importUsers(accessToken: string, accountId: string, userPayload: Array<UserPayload>, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof AccountUsersApi
     */
    patchUserDetails(accessToken: string, accountId: string, userId: string, userPatchPayload: UserPatchPayload, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<User>;
    /**
     ...
     * @memberof AccountUsersApi
     */
    searchUsers(accessToken: string, accountId: string, optionalArgs?: {
        region?: Region;
        name?: string;
        email?: string;
        companyName?: string;
     ...
     */
    getBusinessUnits(accessToken: string, accountId: string, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
     ...
     * @memberof BusinessUnitsApi
     */
    createBusinessUnits(accessToken: string, accountId: string, businessUnitsRequestPyload: BusinessUnitsRequestPyload, optionalArgs?: {
        region?: Region;
        options?: ApsServiceRequestConfig;
    }): Promise<BusinessUnitsResponse>;
}
