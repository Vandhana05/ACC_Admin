...
export class ProjectsApi extends BaseApi {
    ...
    createProject(accessToken, accountId, acceptLanguage, region, userId, projectPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield ProjectsApiFp(this.sdkManager).createProject(accessToken, accountId, acceptLanguage, region, userId, projectPayload, options);
    ...
    createProjectImage(accessToken, projectId, accountId, body, region, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield ProjectsApiFp(this.sdkManager).createProjectImage(accessToken, projectId, accountId, body, region, options);
                const response = yield request(this.axios);
    ...
    getProject(accessToken, projectId, acceptLanguage, region, userId, fields, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield ProjectsApiFp(this.sdkManager).getProject(accessToken, projectId, acceptLanguage, region, userId, fields, options);
                const response = yield request(this.axios);
    ...
    getProjects(accessToken, accountId, acceptLanguage, region, userId, fields, filterClassification, filterPlatform, filterProducts, filterName, filterType, filterStatus, filterBusinessUnitId, filterJobNumber, filterUpdatedAt, filterTextMatch, sort, limit, offset, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield ProjectsApiFp(this.sdkManager).getProjects(accessToken, accountId, acceptLanguage, region, userId, fields, filterClassification, filterPlatform, filterProducts, filterName, filterType, filterStatus, filterBusinessUnitId, filterJobNumber, filterUpdatedAt, filterTextMatch, sort, limit, offset, options);
                const response = yield request(this.axios);
